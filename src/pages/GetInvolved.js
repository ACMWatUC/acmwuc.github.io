...
const GetInvolvedPage = () => (
    <Layout>
        ...
        startups to talk to you. The events are a great way to learn more about the business, hear 
        about some real-world experiences, and network with your favorite companies! </p>
        <p><b>How to Get Involved:</b> Come to the events and bring your friends! We will provide a 
        professional development session prior to the career fair to help you revise your resume 
        and learn how to navigate the event.</p>

        <h2>DigiGirlz</h2>
        <p><b>Purpose:</b> Microsoft Corporation partnered with UC ACM-W to host DigiGirlz day. 
        During the event, high school students interacted with Microsoft employees and managers 
        and University of Cincinnati staff and students to gain exposure to careers in business 
        and technology and to get an inside look at what it’s like to work in the computing industry.</p>
        ...
        Institute and presented in partnership with ACM. Each year we send our ACM-W@UC Exec 
        and org members to network, learn, and grow. Our goal is to send more and more members
        every year! </p>
        <p><b>Date:</b> Sept. 26, Sept. 29 — Oct. 3, 2020</p>
        <p><b>Location:</b> Virtual</p>
        <p><b>How to get Involved:</b> Registration for GHC20 has closed. Please keep an eye out for GHC21 
        in March/April 2021!</p>

        <h2>Ohio Celebration of Women in Computing</h2>
        <p><b>Purpose:</b> OCWiC is a biannual event that gives young women the opportunity to explore 
        careers in IT, to network with other young women, and to meet possible mentors. OCWiC inspires 
        women to complete their studies in computing by expanding their awareness of career possibilities 
        and learning from women leaders from business, industry and academia.</p>
        <p><b>Date:</b> Feb. 2021</p>
        <p><b>Location:</b> Huron, OH</p>
        <p><b>How to Get Involved:</b> More information to come!</p>
